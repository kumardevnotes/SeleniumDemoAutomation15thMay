...
public class SeleniumXPathLocator {
	...
	public static void main(String[] args) throws InterruptedException {
		//To get root folder in your computer
				...
				driver.findElement(By.xpath("//input[@id='email_input']")).sendKeys("johnnitesh2@gmail.com");
				driver.findElement(By.xpath("//input[@id='password_input']")).sendKeys("Testing@123");
